...
let DB = { 
    peptides: [
        { id: 1, slug: 'semaglutide', peptide_name: 'Semaglutide', Category: 'Metabolic', nicknames: 'Ozempic, Wegovy', Status: 'FDA Approved (Weight Loss)', rank: 1, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/semaglutide-official-protocol/', primary_focus: 'Appetite regulation and bodyweight reduction via GLP-1 activity.', research_summary: 'Semaglutide is a glucagon-like peptide-1 (GLP-1) receptor agonist. It increases insulin secretion, decreases glucagon secretion, and slows gastric emptying, leading to significant weight loss and improved glycemic control.', molecular_data: 'C187H291N45O59', faq_questions: 'How does it work?|||What are common side effects?', faq_answers: 'It mimics the GLP-1 hormone that targets areas of the brain that regulate appetite and food intake.|||Nausea, diarrhea, vomiting, and constipation are commonly reported.' },
        { id: 2, slug: 'tirzepatide', peptide_name: 'Tirzepatide', Category: 'Metabolic', nicknames: 'Mounjaro, Zepbound', Status: 'FDA Approved (Weight Loss)', rank: 2, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/tirzepatide-official-protocol/', primary_focus: 'Dual incretin activity tied to weight loss and glucose regulation.', research_summary: 'Tirzepatide is a dual glucose-dependent insulinotropic polypeptide (GIP) and GLP-1 receptor agonist. This dual action leads to greater weight loss and glycemic control compared to selective GLP-1 agonists.', molecular_data: 'C225H348N48O68', faq_questions: 'What makes it different from Semaglutide?|||Is it once weekly?', faq_answers: 'It targets two receptors (GIP and GLP-1) instead of just one, which may enhance its metabolic effects.|||Yes, it is typically administered via subcutaneous injection once per week.' },
        { id: 3, slug: 'bpc-157', peptide_name: 'BPC-157', Category: 'Recovery', nicknames: 'Body Protection Compound 157', Status: 'Research Only', rank: 3, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-wolverine-stack/', primary_focus: 'Soft-tissue recovery, tendon resilience, and gut-related support.', research_summary: 'BPC-157 is a pentadecapeptide composed of 15 amino acids. It is a partial sequence of body protection compound (BPC) that is discovered in and isolated from human gastric juice.', molecular_data: 'C62H98N16O22', faq_questions: 'Is it stable in the gut?|||How is it administered?', faq_answers: 'Yes, BPC-157 is known for its stability in gastric juice, making oral administration viable for GI issues.|||Commonly administered via subcutaneous or intramuscular injection near the injury site, or orally.' },
        { id: 4, slug: 'thymosin-beta-4', peptide_name: 'Thymosin Beta-4', Category: 'Recovery', nicknames: 'TB-500', Status: 'Research Only', rank: 4, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-wolverine-stack/', primary_focus: 'Healing support and tissue-regeneration claims.', research_summary: 'Thymosin Beta-4 is a major actin-sequestering protein in most tissues. It plays a vital role in cell proliferation, migration, and differentiation, which are key to tissue repair.', molecular_data: 'C212H350N56O78S', faq_questions: 'Is TB-500 the same as TB4?|||What is the focus of research?', faq_answers: 'TB-500 is a synthetic version of the active region of Thymosin Beta-4.|||Research focuses on its ability to promote angiogenesis and reduce inflammation in injured tissues.' },
        { id: 5, slug: 'ipamorelin', peptide_name: 'Ipamorelin', Category: 'GH Axis', nicknames: 'NNC 26-0161', Status: 'Research Only', rank: 5, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/ipamorelin-protocol/', primary_focus: 'Growth-hormone secretagogue activity tied to recovery and sleep.', research_summary: 'Ipamorelin is a selective GH secretagogue and ghrelin receptor agonist. It stimulates GH release without significantly affecting cortisol or prolactin levels.', molecular_data: 'C38H49N9O5', faq_questions: 'Does it increase appetite?|||When is it usually taken?', faq_answers: 'Unlike GHRP-6, Ipamorelin does not significantly increase hunger.|||It is often administered before bed to mimic the natural nocturnal pulse of growth hormone.' },
        { id: 6, slug: 'cjc-1295', peptide_name: 'CJC-1295', Category: 'GH Axis', nicknames: 'DAC:GRF', Status: 'Research Only', rank: 6, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/cjc-1295-protocol/', primary_focus: 'Sustained growth-hormone pulse support.', research_summary: 'CJC-1295 is a tetrasubstituted 29-amino acid peptide hormone analog of GHRH. The DAC (Drug Affinity Complex) version extends its half-life significantly.', molecular_data: 'C165H271N47O46', faq_questions: 'What is DAC?|||Is it often stacked?', faq_answers: 'DAC allows the peptide to bind to albumin, extending its duration of action from minutes to days.|||Yes, it is frequently combined with Ipamorelin for synergistic GH release.' },
        { id: 7, slug: 'tesamorelin', peptide_name: 'Tesamorelin', Category: 'GH Axis', nicknames: 'Egrifta', Status: 'FDA Approved (Lipodystrophy)', rank: 7, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/tesamorelin-protocol/', primary_focus: 'Growth hormone stimulation and visceral fat reduction.', research_summary: 'Tesamorelin is a synthetic analog of growth hormone-releasing factor (GRF). It is specifically used to reduce excess abdominal fat in HIV-infected patients with lipodystrophy.', molecular_data: 'C221H366N72O67S', faq_questions: 'Does it target subcutaneous fat?|||Is it a GHRP?', faq_answers: 'Its primary clinical indication is for visceral adipose tissue, not general subcutaneous fat.|||No, it is a GHRH (Growth Hormone Releasing Hormone) analog.' },
        { id: 8, slug: 'mots-c', peptide_name: 'MOTS-c', Category: 'Metabolic', nicknames: 'Mitochondrial Open Reading Frame of the 12S rRNA-c', Status: 'Research Only', rank: 8, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/mots-c-protocol/', primary_focus: 'Metabolic signaling and endurance-related research.', research_summary: 'MOTS-c is a mitochondrial-derived peptide that regulates metabolic homeostasis. It is known to enhance fatty acid oxidation and improve exercise capacity.', molecular_data: 'C101H152N28O22S', faq_questions: 'Is it an exercise mimetic?|||Where is it found?', faq_answers: 'It is often referred to as an "exercise mimetic" because it activates similar metabolic pathways as physical activity.|||It is naturally encoded in the mitochondrial genome.' },
        { id: 9, slug: 'epitalon', peptide_name: 'Epitalon', Category: 'Longevity', nicknames: 'Epithalon, Epithalamin', Status: 'Research Only', rank: 9, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/epitalon-protocol/', primary_focus: 'Longevity-related research and sleep-rhythm claims.', research_summary: 'Epitalon is a synthetic tetrapeptide (Ala-Glu-Asp-Gly) based on a natural peptide called epithalamin. It is researched for its ability to activate telomerase.', molecular_data: 'C14H22N4O9', faq_questions: 'How does it affect sleep?|||What are telomeres?', faq_answers: 'It is believed to regulate melatonin production, which helps normalize circadian rhythms.|||Telomeres are protective caps on chromosomes; Epitalon is studied for its potential to extend them.' },
        { id: 10, slug: 'ghk-cu', peptide_name: 'GHK-Cu', Category: 'Dermal', nicknames: 'Copper Peptide', Status: 'Cosmetic Use', rank: 10, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-glow-up-stack/', primary_focus: 'Skin health, collagen support, and hair-related claims.', research_summary: 'GHK-Cu is a naturally occurring copper complex of the tripeptide glycyl-L-histidyl-L-lysine. It is widely used in skincare for its remodeling and anti-aging properties.', molecular_data: 'C14H24CuN6O4', faq_questions: 'Can it be used topically?|||Does it help with hair growth?', faq_answers: 'Yes, it is very common in high-end anti-aging creams and serums.|||Research suggests it may enlarge hair follicles and stimulate growth in certain models.' },
        { id: 11, slug: 'thymosin-alpha-1', peptide_name: 'Thymosin Alpha-1', Category: 'Immune', nicknames: 'TA1', Status: 'Research Only', rank: 11, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/thymosin-alpha-1-protocol/', primary_focus: 'Immune modulation and resilience research.', research_summary: 'Thymosin Alpha-1 is a peptide fragment derived from prothymosin alpha. It is used to modulate the immune response, particularly in chronic infections and oncology.', molecular_data: 'C129H215N33O55', faq_questions: 'Is it for longevity?|||How does it affect T-cells?', faq_answers: 'It is primarily studied for immune optimization rather than direct lifespan extension.|||It enhances the production and function of T-cells and natural killer (NK) cells.' },
        { id: 12, slug: 'pt-141', peptide_name: 'PT-141', Category: 'Neuro', nicknames: 'Bremelanotide', Status: 'FDA Approved', rank: 12, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/pt-141-protocol/', primary_focus: 'Libido and arousal effects via melanocortin pathways.', research_summary: 'PT-141 is a synthetic peptide analog of alpha-MSH. It acts on the central nervous system to increase sexual desire and function.', molecular_data: 'C50H68N14O10', faq_questions: 'Is it a vasodilator?|||Does it work for both genders?', faq_answers: 'No, it works via the CNS rather than direct blood flow mechanisms like PDE5 inhibitors.|||Yes, it is researched and approved for both men and women.' },
        { id: 13, slug: 'semax', peptide_name: 'Semax', Category: 'Neuro', nicknames: 'MEHFPGP', Status: 'Research Only', rank: 13, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/semax-protocol/', primary_focus: 'Cognitive focus and neuro-support themes.', research_summary: 'Semax is a synthetic heptapeptide consisting of a fragment of ACTH. It is known for its neuroprotective and nootropic effects.', molecular_data: 'C37H51N9O10S', faq_questions: 'Is it a stimulant?|||How is it usually administered?', faq_answers: 'It is considered a nootropic rather than a classical stimulant.|||Commonly used as a nasal spray for direct transport to the brain.' },
        { id: 14, slug: 'selank', peptide_name: 'Selank', Category: 'Neuro', nicknames: 'TP-7', Status: 'Research Only', rank: 14, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/selank-protocol/', primary_focus: 'Anxiolytic and cognitive-enhancing properties.', research_summary: 'Selank is a synthetic derivative of the human tetrapeptide tuftsin. It is used for its anti-anxiety and antidepressant effects.', molecular_data: 'C33H57N11O9', faq_questions: 'Does it cause sedation?|||Is it addictive?', faq_answers: 'Unlike benzodiazepines, Selank typically does not cause sedation or cognitive impairment.|||There is no evidence of dependency or withdrawal in clinical literature.' },
        { id: 15, slug: 'dihexa', peptide_name: 'Dihexa', Category: 'Neuro', nicknames: 'PNB-0408', Status: 'Research Only', rank: 15, forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/dihexa-protocol/', primary_focus: 'Potent synaptogenesis and cognitive support.', research_summary: 'Dihexa is an oligopeptide drug derived from angiotensin IV. It is being researched for its potential to repair brain damage and improve memory.', molecular_data: 'C27H44N4O5', faq_questions: 'Is it orally active?|||What is its primary target?', faq_answers: 'Yes, it is designed to be orally bioavailable and cross the blood-brain barrier.|||It is an HGF (Hepatocyte Growth Factor) activator.' }
    ],
    ...
    stacks: [
        { 
            ...
            rank: 1, 
            forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-wolverine-stack/',
        ...
        { 
            ...
            rank: 2, 
            forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-glow-up-stack/',
        ...
        { 
            ...
            stack_name: 'Limitless Stack', 
            rank: 3, 
            forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-limitless-stack/',
            description: 'A cognitive-first matrix pairing Dihexa and Semax for peak neural performance.', 
            component_list: [
                { name: 'Dihexa', slug: 'dihexa', dosage: '10mg daily' },
                { name: 'Semax', slug: 'semax', dosage: '600mcg BID' }
            ],
            faq_questions: 'Is it for long term use?|||Can I add NAD+?', 
            faq_answers: 'Most researchers use cycling protocols for nootropic stacks.|||Yes, NAD+ is frequently added to enhance cellular energy during cognitive tasks.'
        },
        { 
            slug: 'holy-grail-stack', 
            stack_name: 'Holy Grail', 
            rank: 4, 
            forum_topic_url: 'https://blog.minmaxmuscle.com/forum/topic/protocol-the-holy-grail/',
            description: 'The definitive body composition protocol combining metabolic optimization with hypertrophy support.', 
            component_list: [
                { name: 'Semaglutide', slug: 'semaglutide', dosage: '0.25mg titrated' },
                { name: 'Follistatin-344', slug: 'follistatin-344', dosage: '1mg per cycle' }
            ],
            faq_questions: 'Why combine these?|||Is it safe?', 
            faq_answers: 'This stack targets both fat loss and muscle retention simultaneously.|||Safety is relative to research compliance and medical supervision.'
        }
    ]
};
