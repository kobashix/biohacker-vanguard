...
let DB = {
    ...
    stacks: [
        { 
            ...
            rank: 0, 
            forum_topic_url: "https://blog.minmaxmuscle.com/forum/topic/protocol-the-god-protocol/",
            component_list: [
        ...
        { 
            ...
            rank: 1, 
            forum_topic_url: "https://blog.minmaxmuscle.com/forum/topic/protocol-the-quad-pathway-cagrilintide-retatrutide/",
            component_list: [
        ...
        { 
            ...
            rank: 2, 
            forum_topic_url: "https://blog.minmaxmuscle.com/forum/topic/protocol-metabolic-advanced-cagrilintide-tirzepatide/",
            component_list: [
        ...
        { 
            ...
            rank: 4, 
            forum_topic_url: "https://blog.minmaxmuscle.com/forum/topic/cjc-1295-no-dac-official-research-protocol/",
            component_list: [
        ...
        { 
            ...
            rank: 5, 
            forum_topic_url: "https://blog.minmaxmuscle.com/forum/topic/protocol-visceral-shred-tesamorelin-ipamorelin/",
            component_list: [
        ...
        { 
            ...
            rank: 7, 
            forum_topic_url: "https://blog.minmaxmuscle.com/forum/topic/protocol-cellular-longevity-thymosin-alpha-1-epitalon-mots-c/",
            component_list: [
    ...
    try {
        ...
        if(res.ok) {
            ...
            if (data && data.peptides && data.peptides.length > 0) {
                ...
                // Merge D1 data while prioritizing forum links and restored content
        ...
        console.warn("D1 API unavailable, using internal archive", e);
    }
    
    // Ensure all entries have forum links
